...
此示例演示如何使用的 <xref:System.Windows.Media.Imaging.BitmapSource.Create%2A> 方法 <xref:System.Windows.Media.Imaging.BitmapSource> 创建新的 <xref:System.Windows.Media.Imaging.BitmapSource> 对象。  
