...
- 梯度停止点的 <xref:System.Windows.Media.GradientStop.Color%2A> 属性指定梯度停止点的颜色。 您可以通过使用由类) 提供的预定义颜色 (来设置颜色， <xref:System.Windows.Media.Colors> 也可以指定 ScRGB 或 ARGB 值。 在 [!INCLUDE[TLA2#tla_xaml](../../../includes/tla2sharptla-xaml-md.md)] 中，还可以使用十六进制表示法描述一种颜色。 有关详细信息，请参阅 <xref:System.Windows.Media.Color> 结构。
