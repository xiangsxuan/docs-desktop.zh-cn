...
本主题描述控件的样式和模板 <xref:System.Windows.Controls.Frame> 。 您可以修改默认值 <xref:System.Windows.Controls.ControlTemplate> ，为控件指定独特的外观。 有关详细信息，请参阅为 [控件创建模板](/dotnet/desktop-wpf/themes/how-to-create-apply-template)。  
...
## <a name="frame-states"></a>帧状态  
 下表列出了控件的可视状态 <xref:System.Windows.Controls.Frame> 。  
...
## <a name="frame-controltemplate-example"></a>Frame System.windows.controls.controltemplate> 示例  
 下面的示例演示如何为控件定义 <xref:System.Windows.Controls.ControlTemplate> <xref:System.Windows.Controls.Frame> 。  
