...
- <xref:System.Windows.Forms.DataGrid.HitTest%2A>在相应的事件处理程序中调用方法，如 <xref:System.Windows.Forms.Control.MouseDown> 或事件的 <xref:System.Windows.Forms.Control.Click> 。  
  
     <xref:System.Windows.Forms.DataGrid.HitTest%2A>方法返回一个 <xref:System.Windows.Forms.DataGrid.HitTestInfo> 对象，该对象包含已单击区域的行和列。  
