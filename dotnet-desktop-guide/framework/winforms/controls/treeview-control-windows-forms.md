...
另请参阅 [如何：使用设计器在 Windows 窗体 TreeView 控件中添加和删除节点](add-and-remove-nodes-with-wf-treeview-control-using-the-designer.md)，以及 [如何使用设计器将快捷菜单附加到 TreeNode](how-to-attach-a-shortcut-menu-to-a-treenode-using-the-designer.md)。  
