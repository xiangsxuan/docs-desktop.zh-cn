...
---
# <a name="what-is-windows-presentation-foundation-wpf-net"></a>Windows Presentation Foundation (WPF .NET) 简介
...
WPF 提供一组服务，这些服务可用于扩展类型的[属性](/dotnet/standard/base-types/common-type-system#properties)的功能。 这些服务统称为 WPF 属性系统。 由 WPF 属性系统支持的属性称为依赖属性。
...
在 WPF 中，依赖属性通常公开为标准 .NET [属性](/dotnet/standard/base-types/common-type-system#properties)。 在基本级别，可以直接与这些属性交互，而不必了解它们是以依赖属性的形式实现的。
